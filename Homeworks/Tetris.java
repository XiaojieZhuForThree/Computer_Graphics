...
class getTetris extends Canvas {
	...
	public void paint(Graphics g) {
		...
		xA = (float) xCenter - square * 5; yA = (float) yCenter + square * 10;
		xB = (float) xCenter + square * 6; yB = yA;
		xC = (float) ((float) xCenter - square * 2.5); yC = (float) yCenter + square;
		xD = (float) xCenter + square; yD = (float) yCenter - square * 9;
		xE = (float) xCenter + square * 3; yE = (float) yCenter - square * 9;
		xF = xB + square; yF = yB - (float) 1.5 * square;
		xG = (float) xCenter - square; yG = (float) yCenter + square * 6;
		xI = (float) xCenter + square * 6; yI = (float) yCenter - square;
		xH = xI; yH = yI + square * 2;
		xJ = xH; yJ = yI - 2 * square;
		xK = (float) xCenter + square * 6; yK = (float) yCenter - square * (float)8.5;
		xL = (float) (xK + 0.9 * square); yL = (float) (yK - 1.1 * square);
		xM = (float) (xC + 0.9 * square); yM = (float) (yC - 1.4 * square);
